(function($, owner) {
	...
	owner.getList = function(param, type, container, callback) {
		...
		var uri = owner.serverURI + "Deal/get_unpa_provide_list.html";
		if(type == 1) {
			uri = owner.serverURI + "Deal/get_unpa_provide_list.html";
		}
		if(type == 2) {
			uri = owner.serverURI + "Deal/get_unend_provide_list.html";
		}
		if(type == 3) {
			uri = owner.serverURI + "Deal/get_end_provide_list.html";
		}
